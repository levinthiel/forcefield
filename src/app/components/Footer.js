...
export default function Footer() {
    return (
        <StyledFooter>
            ...
            <FooterLinks>
                <SystemLink href="https://whatsapp.com/channel/0029Vb6b7z3Gk1FoIvxkTz3v">
                ...
                <SystemLink href="https://open.spotify.com/playlist/2bSO3P9jssmmK2rS7iKuaN?si=263539ff2f80417d">
...
const SystemLink = styled(Link)`
    ...
    &:hover {
        ...
        color: var(--beige);
        text-shadow: 0 0 6px var(--ff-glow-red);
    }
`;
